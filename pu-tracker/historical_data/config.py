...
REQUIRED_DATA_COLUMNS = [
    ...
    'Ask_Price', 'Bid_Price', 'Supply', 'Demand', 'Traded Volume',
    'Saturation', 'Input_Cost', 'Profit per Unit',
    'ROI Ask %', 'ROI Bid %', 'Investment_Score', 'Risk', 'Viability',
...
CACHE_FILES = {
    ...
    'material_volumes': 'material_volumes.csv',
